...
int main(int argc, char* argv[])
{
    ...
    // Empty string test
    const wchar_t* src4[] = { nullptr };
    int src4_n = 0;
    const int des4_size = 128;
    wchar_t des4[des4_size];

    int des4_len = ConcatStrings_(des4, des4_size, src4, src4_n);
    const wchar_t* des4_temp = (des4_len==0) ? des4 : L"<empty>";
    wprintf(L"  des_len: %d (%d) des: %s \n", des4_len, wcslen(des4_temp), des4_temp);
